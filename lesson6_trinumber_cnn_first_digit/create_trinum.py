...
def createImages(num, file_name, tags_file_name):
	...
	for i in range (1,num): #how many files
		...
		fontSize=rn.randint(19,22)  #range of font size
		font = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf", fontSize)
		digit=rn.randint(0,999)
		...
		num_string=str(digit/100) + " " + str((digit-(digit/100)*100)/10) + " " + str(digit %10)
		#this string goes into the csv file, we don't want whitespaces there
		num_string_csv=str(digit/100)  + str((digit-(digit/100)*100)/10)  + str(digit %10)
...
createImages(10001, "/home/peter/tensorflow_notes/lesson5_trinumber_cnn/test/","/home/peter/tensorflow_notes/lesson5_trinumber_cnn/test/tags.csv")